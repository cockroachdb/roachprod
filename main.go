...
import (
	...
	"github.com/cockroachdb/roachprod/vm/gcloud"
...
func main() {
	...
	createCmd.Flags().StringSliceVarP(&createVMOpts.VMProviders, "clouds", "c", []string{gcloud.ProviderName}, "The cloud provider(s) to use when creating new vm instances")
