...
The --shutdown flag will kill the process with a (SIGTERM) to allow for a
graceful exit.
` + tagHelp + `
`,
	Args: cobra.ExactArgs(1),
...
func main() {
	...
	stopCmd.Flags().BoolVar(&shutdown, "shutdown", false, "gracefully shutdown.")
